...
static class RealPolynomialRootFinder
{
    ...
    public static List<Complex> FindRoots(params double[] Input)
    {
        ...
        {
            throw new ArgumentException($"Input larger than the maximum allowed - {Degree}>{Max_Degree_Polynomial}");
        }
        ...
        {
            throw new ArgumentException("The leading coefficient is zero");
        }
...
static class ComplexPolynomialRootFinder
{
    ...
    public static List<Complex> FindRoots(params Complex[] Input)
    {
        ...
        return result;
        throw new ArgumentException("The program could not converge to find all the zeroes");
